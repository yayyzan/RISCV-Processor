...
addi t0, t0, 1      # t0 is the random number generated in lfsr)
addi s3, s3, 255    # a0, the output, equals to s3(255), then all lights are on
...
beq s9, zero, lfsr_loop # go next only when s9(x9) equals to 1, or it goes to lfsr loop again
...
counter:
addi t2, t2, 28 # count 28 cycles for 1 second delay
counter_loop:
addi t2, t2, -1
beq t2, zero, counter_loop 
jalr zero, 0(ra)
