...
VL_INLINE_OPT void Vcpu_pipelined___024root___sequent__TOP__0(Vcpu_pipelined___024root* vlSelf) {
    ...
    VL_WRITEF("ins: %x progaddr: %x\n\npcsrc: %b eq: %b jumpaddr: %x\n",
              32,((vlSelf->cpu_pipelined__DOT__fetch__DOT__instrmem__DOT__rom_array
                   ...
                   << 0x18U) | ((vlSelf->cpu_pipelined__DOT__fetch__DOT__instrmem__DOT__rom_array
                                 ...
                                 << 0x10U) | ((vlSelf->cpu_pipelined__DOT__fetch__DOT__instrmem__DOT__rom_array
                                               [(0xfffU 
                                                 & ((IData)(2U) 
                                                    + vlSelf->cpu_pipelined__DOT__pcF))] 
                                               << 8U) 
                                              ...
                                              [(0xfffU 
                                                & ((IData)(3U) 
                                                   + vlSelf->cpu_pipelined__DOT__pcF))]))),
              32,vlSelf->cpu_pipelined__DOT__pcF,1,
              (IData)(vlSelf->cpu_pipelined__DOT__pcsrcE),
              1,vlSelf->cpu_pipelined__DOT__execute__DOT__eq,
              32,((IData)(vlSelf->cpu_pipelined__DOT__jbmuxE)
    ...
    if (vlSelf->cpu_pipelined__DOT__pcsrcE) {
        ...
        vlSelf->cpu_pipelined__DOT__a0E = 0U;
