...
void Vcpu::_initial__TOP__1(Vcpu__Syms* __restrict vlSymsp) {
    ...
    // Body
    vlTOPp->cpu__DOT__programcounter__DOT__branch_pc = 0xbfc00000U;
    vlTOPp->cpu__DOT__memory__DOT__ram__DOT__unnamedblk1__DOT__i = 0x1000U;
    while (VL_GTS_III(1,32,32, 0x20000U, vlTOPp->cpu__DOT__memory__DOT__ram__DOT__unnamedblk1__DOT__i)) {
        vlTOPp->cpu__DOT__memory__DOT__ram__DOT__ram_array[(0x1ffffU 
    ...
    __Vtemp2[1U] = 0x6f697379U;
    __Vtemp2[2U] = 0x63652f6eU;
    __Vtemp2[3U] = 0x6572656eU;
    __Vtemp2[4U] = 0x2f726566U;
    __Vtemp2[5U] = 0x2eU;
    ...
    VL_READMEM_N(true, 8, 4096, 3217031168, VL_CVT_PACK_STR_NW(5, __Vtemp3)
                 , vlTOPp->cpu__DOT__programmem__DOT__rom_array
                 , 3217031168, ~0ULL);
...
void Vcpu::_settle__TOP__3(Vcpu__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->a0_output = vlTOPp->cpu__DOT__registerfile__DOT__rf_array
        [0xaU];
    vlTOPp->cpu__DOT__interm_ins = ((vlTOPp->cpu__DOT__programmem__DOT__rom_array
    ...
    if ((0x67U == (0x7fU & vlTOPp->cpu__DOT__interm_ins))) {
        ...
        vlTOPp->cpu__DOT__programcounter__DOT__branch_pc 
    ...
    vlTOPp->cpu__DOT__programcounter__DOT__next_pc 
...
void Vcpu::_ctor_var_reset() {
    ...
    cpu__DOT__programcounter__DOT__next_pc = VL_RAND_RESET_I(32);
    cpu__DOT__programcounter__DOT__branch_pc = VL_RAND_RESET_I(32);
    { int __Vi0=0; for (; __Vi0<4096; ++__Vi0) {
            cpu__DOT__programmem__DOT__rom_array[__Vi0] = VL_RAND_RESET_I(8);
    }}
