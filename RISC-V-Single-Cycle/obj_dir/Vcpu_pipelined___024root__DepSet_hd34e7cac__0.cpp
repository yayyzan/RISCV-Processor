...
VL_INLINE_OPT void Vcpu_pipelined___024root___sequent__TOP__0(Vcpu_pipelined___024root* vlSelf) {
    ...
    VL_WRITEF("ins: %x progaddr: %x\n\n",32,((vlSelf->cpu_pipelined__DOT__fetch__DOT__instrmem__DOT__rom_array
                                              [(0xfffU 
                                             ...
                                             | ((vlSelf->cpu_pipelined__DOT__fetch__DOT__instrmem__DOT__rom_array
                                                ...
                                                | ((vlSelf->cpu_pipelined__DOT__fetch__DOT__instrmem__DOT__rom_array
                                                   ...
                                                   (0xfffU 
                                                    & ((IData)(3U) 
                                                       + vlSelf->cpu_pipelined__DOT__pcF))]))),
              32,vlSelf->cpu_pipelined__DOT__pcF);
    ...
    if (vlSelf->cpu_pipelined__DOT__memwriteM) {
        ...
        __Vdlyvdim0__cpu_pipelined__DOT__memory__DOT__ram__DOT__ram_array__v0 
            = (0x1fffcU & vlSelf->cpu_pipelined__DOT__aluresultM);
    ...
    vlSelf->cpu_pipelined__DOT__memory__DOT__ramout 
        = ((vlSelf->cpu_pipelined__DOT__memory__DOT__ram__DOT__ram_array
            [(0x1ffffU & ((IData)(3U) + (0x1fffcU & vlSelf->cpu_pipelined__DOT__aluresultM)))] 
...
VL_INLINE_OPT void Vcpu_pipelined___024root___sequent__TOP__1(Vcpu_pipelined___024root* vlSelf) {
    ...
    // Body
    VL_WRITEF("s4: %x\ts5: %x\ts6: %x\t a0:%x \t a1: %x\t a2: %x\ta3: %x\ta4: %x\ta5: %x\ta6: %x\t\n",
              32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0x14U],32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0x15U],32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0x16U],32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0xaU],32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0xbU],32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0xcU],32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0xdU],32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0xeU],32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0xfU],32,vlSelf->cpu_pipelined__DOT__decode__DOT__rfD__DOT__rf_array
              [0x10U]);
