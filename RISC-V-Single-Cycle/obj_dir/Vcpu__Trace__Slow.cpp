...
void Vcpu::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+77,"cpu WIDTH", false,-1, 31,0);
        ...
        tracep->declBus(c+76,"cpu pc_plus4", false,-1, 31,0);
        ...
        tracep->declBus(c+77,"cpu fetch A_WIDTH", false,-1, 31,0);
        tracep->declBus(c+78,"cpu fetch D_WIDTH", false,-1, 31,0);
        tracep->declBit(c+20,"cpu fetch pcsrc", false,-1);
        tracep->declBit(c+73,"cpu fetch clk", false,-1);
        tracep->declBit(c+74,"cpu fetch rst", false,-1);
        tracep->declBit(c+25,"cpu fetch jbmux", false,-1);
        tracep->declBus(c+11,"cpu fetch jumpaddress", false,-1, 31,0);
        tracep->declBus(c+7,"cpu fetch dout", false,-1, 31,0);
        tracep->declBus(c+6,"cpu fetch pc", false,-1, 31,0);
        tracep->declBus(c+76,"cpu fetch pc_plus4", false,-1, 31,0);
        tracep->declBus(c+77,"cpu fetch pcountunit WIDTH", false,-1, 31,0);
        tracep->declBit(c+20,"cpu fetch pcountunit pcsrc", false,-1);
        tracep->declBit(c+73,"cpu fetch pcountunit clk", false,-1);
        tracep->declBit(c+74,"cpu fetch pcountunit rst", false,-1);
        tracep->declBit(c+25,"cpu fetch pcountunit jbmux", false,-1);
        tracep->declBus(c+11,"cpu fetch pcountunit jumpaddress", false,-1, 31,0);
        tracep->declBus(c+6,"cpu fetch pcountunit pc", false,-1, 31,0);
        tracep->declBus(c+76,"cpu fetch pcountunit pc_plus4", false,-1, 31,0);
        tracep->declBus(c+29,"cpu fetch pcountunit next_pc", false,-1, 31,0);
        tracep->declBus(c+30,"cpu fetch pcountunit branch_pc", false,-1, 31,0);
        tracep->declBus(c+77,"cpu fetch instrmem A_WIDTH", false,-1, 31,0);
        tracep->declBus(c+78,"cpu fetch instrmem D_WIDTH", false,-1, 31,0);
        tracep->declBus(c+6,"cpu fetch instrmem address", false,-1, 31,0);
        tracep->declBus(c+7,"cpu fetch instrmem dout", false,-1, 31,0);
        ...
        tracep->declBus(c+77,"cpu alu D_WIDTH", false,-1, 31,0);
        ...
        tracep->declBus(c+79,"cpu registerfile A_WIDTH", false,-1, 31,0);
        tracep->declBus(c+77,"cpu registerfile D_WIDTH", false,-1, 31,0);
        ...
        tracep->declBus(c+77,"cpu memory ADDRESS_WIDTH", false,-1, 31,0);
        tracep->declBus(c+77,"cpu memory DATA_WIDTH", false,-1, 31,0);
        ...
        tracep->declBus(c+77,"cpu memory storemem DATA_WIDTH", false,-1, 31,0);
        ...
        tracep->declBus(c+77,"cpu memory ram ADDRESS_WIDTH", false,-1, 31,0);
        tracep->declBus(c+78,"cpu memory ram DATA_WIDTH", false,-1, 31,0);
        ...
        tracep->declBus(c+77,"cpu memory loadmem D_WIDTH", false,-1, 31,0);
...
void Vcpu::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+29,(vlTOPp->cpu__DOT__fetch__DOT__pcountunit__DOT__next_pc),32);
        tracep->fullIData(oldp+30,(vlTOPp->cpu__DOT__fetch__DOT__pcountunit__DOT__branch_pc),32);
        ...
        tracep->fullIData(oldp+76,(vlTOPp->pc_plus4),32);
        tracep->fullIData(oldp+77,(0x20U),32);
