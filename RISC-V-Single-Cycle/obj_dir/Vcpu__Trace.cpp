...
void Vcpu::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgIData(oldp+28,(vlTOPp->cpu__DOT__fetch__DOT__pcountunit__DOT__next_pc),32);
            tracep->chgIData(oldp+29,(vlTOPp->cpu__DOT__fetch__DOT__pcountunit__DOT__branch_pc),32);
        ...
        tracep->chgIData(oldp+75,(vlTOPp->pc_plus4),32);
    }
}
